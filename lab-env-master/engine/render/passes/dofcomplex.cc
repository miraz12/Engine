...
namespace Passes
{
	...
	DofComplex::DofComplex()
    {
		...
		xpass = std::make_shared<Resources::ShaderObject>("content/Shader/complexdof.vs", "content/Shader/complexdof.fs");
		ypass = std::make_shared<Resources::ShaderObject>("content/Shader/complexdofy.vs", "content/Shader/complexdofy.fs");
		...
		//Component 2 NOTE: No need for the zw components as they can be calculated with the weights of the real and imaginary components
