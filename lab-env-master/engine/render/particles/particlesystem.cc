...
Particlesystem::Particlesystem()
{
	...
	spread = 2.0f;
	min_age = 0.0f;
	shaderRs = std::make_shared<ShaderObject>("content/Shader/particles.vs", "content/Shader/particles.fs");
	textureRs = std::make_shared<TextureResource>("content/smoke.png");
	textureRs->Load();
